...
gulp.task('server', function () {
  ...
  gulp.watch(`source/js/script.js`, gulp.series(`main`, `refresh`));
...
gulp.task('build', gulp.series('clean', 'copy', 'css', 'main', 'vendor', 'sprite', 'html'));
